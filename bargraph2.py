...
class bargraph2:
    def view():
        ...
        a1=[];a2=[]
        for a in algo:
            cursor.execute("select precesion from evaluations where algorithm='"+str(a)+"' and dataset='Testset1' ")
            row = cursor.fetchall()
        ...
        print(a1,a2)
        plt.bar(br1, a1, color='y', width=barWidth,
        ...
        plt.legend()
        plt.savefig('D:\\MAJOR-PROJECT\\Protein Sequences - V2 (2) new\\Protein Sequences - V2 new\\static\\assets\\images\\g2.jpg', dpi = (200))
